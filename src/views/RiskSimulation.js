...
import { pieData } from "../utilities/SimulationPieData.js";
    ...
    return (
        <SideWrapper>
            ...
            >
                ...
                <LocationHeader forcedText={'Risk / Cost Impact Simulation'} />
                ...
                <SpacedStack>
                    ...
                    <Stack
                        ...
                        mb={'20px'}
                    >
                        <Text p={'12px 18px'} color={'#262626'} fontSize={'18px'} fontWeight={'600'} bgColor={'#f6f6f6'} borderRadius={'5px'}>Incident Response</Text>
                        <Box
                            py={'12px'}
                            display={'flex'}
                            w={'full'}
                    ...
                    <Stack
                        ...
                        mb={'20px'}
                    >
                        <Text p={'12px 18px'} color={'#262626'} fontSize={'18px'} fontWeight={'600'} bgColor={'#f6f6f6'} borderRadius={'5px'}>Resiliency</Text>
                        <Box
                            py={'12px'}
                            display={'flex'}
                            w={'full'}
                    ...
                    <Stack
                        ...
                        mb={'20px'}
                    >
                        <Text p={'12px 18px'} color={'#262626'} fontSize={'18px'} fontWeight={'600'} bgColor={'#f6f6f6'} borderRadius={'5px'}>Ransomware</Text>
                        <Box
                            py={'12px'}
                            display={'flex'}
                            w={'full'}
                    ...
                    <Stack
                        ...
                        mb={'20px'}
                    >
                        <Text p={'12px 18px'} color={'#262626'} fontSize={'18px'} fontWeight={'600'} bgColor={'#f6f6f6'} borderRadius={'5px'}>Zero-Trust</Text>
                        <Box
                            py={'12px'}
                            display={'flex'}
                            w={'full'}
