...
import { Box, Icon, Image,Input, Stack, Button, Heading, Select, Text, Accordion, AccordionItem, AccordionButton, AccordionPanel, Input as CharkInput } from "@chakra-ui/react";
...
export default function CloudLogin({filterData,sendData}) {
...
>
    <Box w={'full'} className="vendorConfigOpt">
        ...
        <Input
            ...
            value={filterData.configurations.host.credentials.clientId??null}
        />
        <Typography.Text>Client Secret Key / Access Key Secret</Typography.Text>
        <Input
            size="large"
            placeholder="kjuyt67765tgg"
            value={filterData.configurations.host.credentials.clientSecret??null}
        />
        <Typography.Text>Tenant Id</Typography.Text>
        <Input
            size="large"
            placeholder="13333558ki8u-00ikxn"
            value={filterData.configurations.host.credentials.tenantId??null}
        />
        <Typography.Text>Subscription Id</Typography.Text>
        <Input
            size="large"
            placeholder="4lkxbb0(kk_@2"
            value={filterData.configurations.host.credentials.subscriptionId??null}
        />
    </Box>
    <Box w={'full'}>
                            ...
                            >
                                ...
                                >
                                    <Input
                                        ...
                                        style={{ width: '82px' }}
                                        size="large"
                                        onChange={(e)=>{setVariableData(...variableData,)}}
                                        placeholder="Value 1"
                                    />
                                </Box>
                            </Stack>
